...
for a_row in data:
    ...
    match_card = a_row['match card']
    wrestling_matches.append([matchdate, some_wrestlers, match_card, a_promotion, event_title, event_location])

import csv
with open('wrestlingmatches_with_titlechange.csv', 'w') as fp:
