...
url = "http://www.cagematch.net/?id=112&view=search&sEventName=Raw&sEventType=TV-Show&sDateFromDay=23&sDateFromMonth=08&sDateFromYear=1995&sDateTillDay=27&sDateTillMonth=09&sDateTillYear=1998&sPromotion=1&sRegion=Amerika&sWorkerRelationship=Any&s="
...
#lets ask requests to get that page
	...
	url = "http://www.cagematch.net/?id=112&view=search&sEventName=Raw&sEventType=TV-Show&sDateFromDay=23&sDateFromMonth=08&sDateFromYear=1995&sDateTillDay=27&sDateTillMonth=09&sDateTillYear=1998&sPromotion=1&sRegion=Amerika&sWorkerRelationship=Any&s=" + str(total_pages * 100)

		

with open('scrapedmatchdata_til8.23.1995_WWF.json', 'w') as f:
