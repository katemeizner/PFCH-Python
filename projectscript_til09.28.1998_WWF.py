...
url = "http://www.cagematch.net/?id=112&view=search&sEventName=Raw&sEventType=TV-Show&sDateFromDay=28&sDateFromMonth=09&sDateFromYear=1998&sDateTillDay=26&sDateTillMonth=03&sDateTillYear=2001&sPromotion=1&sRegion=Amerika&sWorkerRelationship=Any&s="
...
#lets ask requests to get that page
	...
	url = "http://www.cagematch.net/?id=112&view=search&sEventName=Raw&sEventType=TV-Show&sDateFromDay=28&sDateFromMonth=09&sDateFromYear=1998&sDateTillDay=26&sDateTillMonth=03&sDateTillYear=2001&sPromotion=1&sRegion=Amerika&sWorkerRelationship=Any&s=" + str(total_pages * 100)

		

with open('scrapedmatchdata_til9.28.1998_WWF.json', 'w') as f:
