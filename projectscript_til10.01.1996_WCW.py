...
url = "http://www.cagematch.net/?id=112&view=search&sEventName=WCW%20Monday%20Nitro&sEventType=TV-Show&sDateFromDay=01&sDateFromMonth=10&sDateFromYear=1996&sDateTillDay=19&sDateTillMonth=10&sDateTillYear=1998&sPromotion=2&sRegion=Amerika&sWorkerRelationship=Any&s="
...
#lets ask requests to get that page
	...
	url = "http://www.cagematch.net/?id=112&view=search&sEventName=WCW%20Monday%20Nitro&sEventType=TV-Show&sDateFromDay=01&sDateFromMonth=10&sDateFromYear=1996&sDateTillDay=19&sDateTillMonth=10&sDateTillYear=1998&sPromotion=2&sRegion=Amerika&sWorkerRelationship=Any&s=" + str(total_pages * 100)

		

with open('scrapedmatchdata_til10.01.1996_WCW.json', 'w') as f:
