...
url = "http://www.cagematch.net/?id=112&view=search&sEventName=WCW%20Monday%20Nitro&sEventType=TV-Show&sDateFromDay=20&sDateFromMonth=10&sDateFromYear=1998&sDateTillDay=26&sDateTillMonth=03&sDateTillYear=2001&sPromotion=2&sRegion=Amerika&sWorkerRelationship=Any&s="
...
#lets ask requests to get that page
	...
	url = "http://www.cagematch.net/?id=112&view=search&sEventName=WCW%20Monday%20Nitro&sEventType=TV-Show&sDateFromDay=20&sDateFromMonth=10&sDateFromYear=1998&sDateTillDay=26&sDateTillMonth=03&sDateTillYear=2001&sPromotion=2&sRegion=Amerika&sWorkerRelationship=Any&s=" + str(total_pages * 100)

		

with open('scrapedmatchdata_til10.19.1998_WCW.json', 'w') as f:
